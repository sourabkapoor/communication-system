<html>
<head>
<title>Welcome to Intra Organization Communication System</title>
<script>
function check()
{
...
<body leftmargin=0 Topmargin=0 bgcolor=#FFFFFF text=#BC5461
	background="login_Back.png" link="#BC54FF" vlink="#FF54FF"
	alink="#FF5400">
	<font size=+2>
		<body leftmargin=0 Topmargin=0 bgcolor="#a9a9a9" text=#BC5461
			link="#BC54FF" vlink="#FF54FF" alink="#FF5400">
			<font size=+2> <blink>
					<center></center>
				</blink>
				<center>
					<img border="0" src="aaa.png" width="950" height="70">
						...
						<tr>
							...
							<td>
								<form method=post name=signmeup action="Serv_SignMeUp"
									...
									<!--Strat Table tag-->
									<table cellpadding=10 bgcolor="peachpuff" width="400"
										height="600" align="right">
										<tr>
											<td><font face="Verdana" color="#000080"><b>User
														Name</b></font></td>
											<td><font face="Verdana" color="#000080"><b><input
														type=text name=uname value=""></b></font></td>
										</tr>

										<tr>
											<td><font face="Verdana" color="#000080"><b>Password&nbsp;</b></font>
											</td>
											<td><font face="Verdana" color="#000080"><b><input
														type=password name=pwd></b></font></td>
										</tr>

										<tr>
											<td><font face="Verdana" color="#000080"><b>Retype
														Password</b></font></td>
											<td><font face="Verdana" color="#000080"><b><input
														type=password name=pwd1 value=""></b></font></td>
										</tr>

										<tr>
											<td><font face="Verdana" color="#000080"><b>Age</b></font>
											</td>
											<td><font face="Verdana" color="#000080"><b><input
														type=text name=age></b></font></td>
										</tr>

										<tr>
											<td><font face="Verdana" color="#000080"><b>
														Sex</b></font></td>
											<td><font face="Verdana" color="#000080"><b><input
														type=radio name=r1 value=Male checked>Male <input
														type=radio name=r1 value=Female>Female</b></font></td>
										</tr>

										<tr>
											<td><font face="Verdana" color="#000080"><b>City</b></font>
											</td>
											<td><font face="Verdana" color="#000080"><b><input
														type=text name=city></b></font></td>
										</tr>
										...
										<tr>
											<td><font face="Verdana" color="#000080"><b>Pin
														Code&nbsp;</b></font></td>
											<td><input type=text name=pin maxlength=6 value="">
											</td>
										</tr>
										<tr>
											<td><font face="Verdana" color="#000080"><b>
										...
										<tr>
											<td colspan="2" align="center"><font size="2"
												color="#000080"> <input type=submit name=regis
													value="Register"
													style="color: #000080; font-family: Verdana; font-weight: bold">&nbsp;&nbsp;
													&nbsp;&nbsp;&nbsp;&nbsp;
											</font> <font size=+2>&nbsp;&nbsp; <input type=Reset
													name=reset value="Reset"
													style="color: #000080; font-family: Verdana; font-weight: bold"></font>
											</td>
										</tr>
									</table>
									<!--Closing Table tag-->
