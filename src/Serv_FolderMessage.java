...
public class Serv_FolderMessage extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        try
        {
            ...
            for(rs = st.executeQuery("select mfrom,mto,sub,mcc,mdata,folder,mailst,maildate,MAILEXCH from newfolder where mid=" + i); rs.next(); servletoutputstream.println("</form></body></html>"))
            {
                ...
                if(at != null)
            	{
            	servletoutputstream.println("<hr><table cellpadding=15><tr><td><a href=Serv_Download?from=" + at + "&subj=" + s2 + "+fname>attachment</a>");
            	}
