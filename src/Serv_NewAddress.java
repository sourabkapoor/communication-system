...
public class Serv_NewAddress extends HttpServlet
{
	...
	con=ConnectionProvider.getConnection();
            ...
            servletoutputstream.println("<b>Name     </b>:   <input type=text name=nam ><br>");
            servletoutputstream.println("<b>Nick Name</b>:   <input type=text name=nname ><br>");
            servletoutputstream.println("<b>E-mail Id</b>:   <input type=mail name=mid ><br>");
            servletoutputstream.println("<b>Address  </b>:   <input type=text name=add ><br>");
            servletoutputstream.println("<b>Phone No.</b>:   <input type=number name=pno maxlength='10'><br><br>");
