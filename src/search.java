...
System.out.println("conn for search page");
            ...
            servletoutputstream.println("<body bgcolor=white background='dii.jpg' text=navy>");
            ...
            resultset1.close();
            st.close();
            String ss = httpservletrequest.getParameter("search");
            ...
            rs1 = st1.executeQuery("select mailid,mailfrom,subject,maildate,mailst from newcompose where mailto='" + uname + "' and mailfrom='"+ss+"'");
            int j = 0;
            while(rs1.next()) 
            {
                j++;
