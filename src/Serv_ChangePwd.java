...
public class Serv_ChangePwd extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        try
        {
            ...
            int i = st.executeUpdate("Update signupdetails set passwd='" + s + "' where uname='" + un + "' and passwd='"+op+"'");
            if(i==1)
            {
            ...
            {
            	 servletoutputstream.println("<html><body bgcolor=white background='INDTEXTB.JPG' text=blue><h2><i>u have enter wrong old password...</i></h2></body></html>");
                 httpservletresponse.setHeader("Refresh", "2;URL=Serv_Option");
            }
        }
        catch(Exception exception)
        {
